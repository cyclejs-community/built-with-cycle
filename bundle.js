...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function renderSidebar(){return(0,_dom.div)(".sidebar",[(0,_dom.h2)("Built with Cycle.js"),(0,_dom.img)({src:"http://cycle.js.org/img/cyclejs_logo.svg",alt:"Cycle.js"})])}function renderProject(e){return(0,_dom.div)(".project",[(0,_dom.a)(".homepage",{href:e.homepage,target:"_blank"},[(0,_dom.h3)(".name",e.name)]),(0,_dom.div)(".description",e.description),(0,_dom.img)({src:e.screenshot,alt:e.name})])}function renderProjects(e){return(0,_dom.div)(".projects",e.map(renderProject))}function App(e){e.DOM;return{DOM:_rx.Observable.just((0,_dom.div)(".built-with-cycle",[renderSidebar(),renderProjects(_projects2["default"])]))}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=App;var _rx=require("rx"),_dom=require("@cycle/dom"),_projects=require("../data/projects"),_projects2=_interopRequireDefault(_projects);
